...
describe('favorite blog', () => {
  ...
  test('when list has only one blog, that one is the favorite', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, that author has one blog', () => {
  ...
  test('of a bigger list finds the author with most blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog, that author has all the likes', () => {
  ...
  test('of a bigger list finds the author with most likes total', () => {
